 ...
 * Generated at: 2025-10-31 01:30:52 UTC
...
public final class music_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if ("ADMIN".equals(currentRole)) { 
      ...
      out.write("  @media (min-width: 1100px){ .media-columns { display:grid; grid-template-columns: 1fr 1fr; gap:16px; align-items:start; } }\r\n");
...
try { Class.forName("org.mariadb.jdbc.Driver"); mariaLoaded = true; } catch (Throwable th) { /* ignore */ }
    ...
    if (ids.isEmpty()) {
      ...
      out.write("    <h3 class=\"section-title\"><span class=\"ico\"><i class=\"fab fa-spotify\" style=\"color:var(--spotify)\"></i></span> ");
      ...
      out.write("      <button id=\"spotifyDock\" style=\"padding:6px 10px; margin-left:8px;\">Přehrát dole</button>\r\n");
      out.write("    </div>\r\n");
      out.write("  </section>\r\n");
      out.write("\r\n");
      ...
      out.write("    }\r\n");
      out.write("  }\r\n");
      out.write("  $('#spotifyLoad').on('click', function(){ tryLoadSpotify(); });\r\n");
      out.write("  $('#spotifyDock').on('click', function(){ var src=$('#spotifyEmbed').data('src'); if(window.playSpotify) window.playSpotify(src); else { tryLoadSpotify(); } });\r\n");
