 ...
 * Generated at: 2025-10-31 12:05:02 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String __lang = (String) session.getAttribute("lang"); if (__lang == null) __lang = "cs"; out.print(__lang); 
      ...
      out.write("\r\n");
      out.write("<main>\r\n");
      out.write("  <section style=\"text-align:center; padding:10px 0 6px;\">\r\n");
      out.write("    <h2 class=\"comforter-brush-regular\" style=\"font-size:3rem; margin:0;\">SKELOSQUAD</h2>\r\n");
      out.write("    <p style=\"margin:6px 0 0;\">");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("index.hero","Official website – music, lyrics, news.") );
      out.write("</p>\r\n");
      out.write("  </section>\r\n");
      out.write("  <section style=\"display:grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap:16px; margin-top:14px;\">\r\n");
      out.write("    <a class=\"section\" href=\"music.jsp\" style=\"text-decoration:none; color:inherit; background:rgba(255,255,255,0.55); border:1px solid var(--panel-border); border-radius:12px; padding:16px;\">\r\n");
      out.write("      <h3><i class=\"fas fa-music\"></i> ");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("tile.music.title","Music") );
      out.write("</h3>\r\n");
      out.write("      <p>");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("tile.music.desc","YouTube videos and Spotify playlist.") );
      out.write("</p>\r\n");
      out.write("    </a>\r\n");
      out.write("    <a class=\"section\" href=\"texty.jsp\" style=\"text-decoration:none; color:inherit; background:rgba(255,255,255,0.55); border:1px solid var(--panel-border); border-radius:12px; padding:16px;\">\r\n");
      out.write("      <h3><i class=\"fas fa-align-left\"></i> ");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("tile.lyrics.title","Lyrics") );
      out.write("</h3>\r\n");
      out.write("      <p>");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("tile.lyrics.desc","Browse lyrics, vote and comment.") );
      out.write("</p>\r\n");
      out.write("    </a>\r\n");
      out.write("    <a class=\"section\" href=\"about.jsp\" style=\"text-decoration:none; color:inherit; background:rgba(255,255,255,0.55); border:1px solid var(--panel-border); border-radius:12px; padding:16px;\">\r\n");
      out.write("      <h3><i class=\"fas fa-user\"></i> ");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("tile.about.title","About") );
      out.write("</h3>\r\n");
      out.write("      <p>");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("tile.about.desc","Who I am and how I create.") );
      out.write("</p>\r\n");
      out.write("    </a>\r\n");
      out.write("  </section>\r\n");
      out.write("\r\n");
      out.write("  <style>\r\n");
      out.write("    .news-grid { display:grid; grid-template-columns: 2fr 1fr; gap:16px; margin-top:18px; }\r\n");
      out.write("    @media (max-width: 800px){ .news-grid { grid-template-columns: 1fr; } }\r\n");
      out.write("    .card { background: var(--panel); border:1px solid var(--panel-border); border-radius:12px; padding:16px; box-shadow: 0 6px 18px rgba(0,0,0,0.20); }\r\n");
      out.write("    .videos { display:grid; grid-template-columns: repeat(auto-fit, minmax(220px,1fr)); gap:12px; }\r\n");
      out.write("    .video { background: rgba(0,0,0,0.55); border:1px solid var(--panel-border); border-radius:10px; overflow:hidden; }\r\n");
      out.write("    .video img { width:100%; height:128px; object-fit:cover; display:block; }\r\n");
      out.write("    .video .meta { padding:8px; font-size:0.95em; }\r\n");
      out.write("    .newsletter input[type=email]{ width:100%; box-sizing:border-box; margin-bottom:8px; }\r\n");
      out.write("    .newsletter button { background:transparent; border:1px solid var(--panel-border); color:var(--text); padding:6px 10px; border-radius:8px; cursor:pointer; }\r\n");
      out.write("    .newsletter button:hover { background: rgba(255,255,255,0.08); }\r\n");
      out.write("  </style>\r\n");
      out.write("\r\n");
      out.write("  <section class=\"news-grid\">\r\n");
      out.write("    <div class=\"card\">\r\n");
      out.write("      <h3 class=\"bruno-ace-sc-regular\" style=\"margin-top:0;\">🗞️ ");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("home.news","Novinky") );
      out.write("</h3>\r\n");
      ...
      out.write("\r\n");
      out.write("                  <a class=\"video\" href=\"https://www.youtube.com/watch?v=");
      out.print( vid );
      ...
      out.print( title );
      out.write("</div>\r\n");
      out.write("                      <div style=\"font-size:0.85em; opacity:0.8;\">");
      out.print( dateStr );
      out.write("</div>\r\n");
      out.write("                    </div>\r\n");
      out.write("                  </a>\r\n");
      ...
      out.write("\r\n");
      out.write("              <div>");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("home.news.none","Žádná videa k zobrazení.") );
      out.write("</div>\r\n");
      out.write("        ");
      ...
      out.write("\r\n");
      out.write("            <div>Chyba načítání videí: ");
      ...
      out.write("    </div>\r\n");
      out.write("    <div class=\"card\">\r\n");
      out.write("      <h3 class=\"bruno-ace-sc-regular\" style=\"margin-top:0;\">🎤 ");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("home.concerts","Koncerty") );
      out.write("</h3>\r\n");
      out.write("      <ul style=\"margin:0; padding-left:18px;\">\r\n");
      out.write("        <li>");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("home.concerts.none","Zatím nejsou naplánovány žádné koncerty.") );
      out.write("</li>\r\n");
      out.write("      </ul>\r\n");
      out.write("      <hr style=\"border-color:var(--panel-border); opacity:.5;\">\r\n");
      out.write("      <div class=\"newsletter\">\r\n");
      out.write("        <h4 style=\"margin:6px 0 8px;\">📧 ");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("home.newsletter.title","Novinky e-mailem") );
      out.write("</h4>\r\n");
      out.write("        <form method=\"post\" action=\"/subscribe\">\r\n");
      out.write("          <input type=\"hidden\" name=\"csrf\" value=\"");
      out.print( request.getAttribute("csrf") );
      out.write("\">\r\n");
      out.write("          <input type=\"email\" name=\"email\" placeholder=\"");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("home.newsletter.placeholder","Tvůj e-mail") );
      out.write("\" required>\r\n");
      out.write("          <button type=\"submit\">");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("home.newsletter.submit","Odebírat") );
      out.write("</button>\r\n");
      out.write("        </form>\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>\r\n");
