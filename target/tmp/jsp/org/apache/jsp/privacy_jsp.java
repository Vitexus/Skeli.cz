 ...
 * Generated at: 2025-10-28 23:01:00 UTC
...
public final class privacy_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if ("ADMIN".equals(currentRole)) { 
      ...
      out.write("\r\n");
      out.write("<main>\r\n");
      out.write("  <h2>Zásady ochrany osobních údajů</h2>\r\n");
      out.write("  <p>Tento web zpracovává pouze údaje nezbytné pro provoz účtu (uživatelské jméno, hash hesla). Hesla ukládáme jako bcrypt hash. Komentáře jsou veřejné.</p>\r\n");
      out.write("  <p>Externí platformy (YouTube, Spotify) se načítají až po Vašem souhlasu. Souhlas můžete kdykoli změnit smazáním položky „cookieConsent“ v úložišti prohlížeče.</p>\r\n");
      out.write("  <p>Správce: Skeli. Kontakt: <a href=\"mailto:privacy@skeli.cz\">privacy@skeli.cz</a></p>\r\n");
      out.write("</main>\r\n");
      out.write("\r\n");
