 ...
 * Generated at: 2025-10-28 23:27:16 UTC
...
public final class texty_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if ("ADMIN".equals(currentRole)) { 
      ...
      out.write("    <style>\r\n");
      out.write("      .texts-list { list-style:none; padding:0; margin:0; display:block; }\r\n");
      out.write("      .texts-list li { margin:6px 0; text-align:center; }\r\n");
      out.write("    </style>\r\n");
...
try { Class.forName("org.mariadb.jdbc.Driver"); mariaLoaded = true; } catch (Throwable th) { out.println("<!-- MariaDB driver not found: " + th.getMessage() + " -->"); }
      ...
      out.write("\r\n");
      out.write("                            <li><a href=\"/lyrics/");
      out.print( lyricId );
      out.write('-');
      out.print( name.toLowerCase().replaceAll("[^a-z0-9]+","-").replaceAll("^-|-$","") );
      out.write('"');
      out.write('>');
      out.print( name );
      out.write("</a></li>\r\n");
