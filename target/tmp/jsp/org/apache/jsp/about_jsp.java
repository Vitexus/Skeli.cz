 ...
 * Generated at: 2025-10-31 01:30:39 UTC
...
public final class about_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/includes/header.jsp", Long.valueOf(1761751494300L));
    _jspx_dependants.put("/WEB-INF/i18n/i18n.jspf", Long.valueOf(1761733093757L));
  }
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<style>\r\n");
      out.write(":root { --bg:#0b0c0d; --text:#e7e9ea; --panel:rgba(0,0,0,0.60); --panel-strong:rgba(0,0,0,0.75); --panel-border:rgba(255,255,255,0.18); --accent:#00d1ff; --spotify:#CC2B2B; --youtube:#FF0000; --fw:400; }\r\n");
      out.write("body.light { --bg:#f6f6f6; --text:#111; --panel:#ffffff; --panel-strong:#ffffff; --panel-border:rgba(0,0,0,0.18); --accent:#007acc; }\r\n");
      out.write("body.dark { --bg:#0b0c0d; --text:#e7e9ea; --panel:rgba(0,0,0,0.60); --panel-strong:rgba(0,0,0,0.75); --panel-border:rgba(255,255,255,0.18); --accent:#00d1ff; }\r\n");
      ...
      out.write("  .sp-minbar { position:fixed; left:50%; transform:translateX(-50%); bottom:10px; z-index:9998; display:none; background: rgba(0,0,0,0.65); color:#fff; border:1px solid var(--panel-border); border-radius:999px; padding:6px 10px; cursor:pointer; box-shadow:0 8px 22px rgba(0,0,0,.35); }\r\n");
      ...
      out.write("  body.light .sp-hide { background: rgba(255,255,255,0.9); color:#111; border-color: rgba(0,0,0,0.15); }\r\n");
  ...
  if (lang != null && (lang.equals("cs")||lang.equals("en")||lang.equals("de")||lang.equals("sk")||lang.equals("uk"))) {
 ...
 String currentUser = (String) session.getAttribute("username"); String currentRole = (String) session.getAttribute("role"); 
      ...
      out.write("            <li><a href=\"?lang=sk\">Slovensky 🇸🇰</a></li>\r\n");
 ...
 if ("ADMIN".equals(currentRole)) { 
      ...
      out.write("      const min=document.createElement('div'); min.id='sp-min'; min.className='sp-minbar'; min.textContent='▲ Otevřít přehrávač';\r\n");
      ...
      out.write("    function closeBar(){ const bar=ensureSpBar(); bar.style.display='none'; const m=document.getElementById('sp-min'); m.style.display='block'; m.textContent='▲ Otevřít přehrávač'; localStorage.setItem('sp_min','1'); }\r\n");
      ...
      out.write("      else { bar.style.display='none'; document.getElementById('sp-min').style.display='block'; }\r\n");
      out.write("    })();\r\n");
      out.write("\r\n");
      ...
      out.write("    <h2>");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("about.title","About me") );
      out.write("</h2>\r\n");
      out.write("    <p>");
      out.print( ((java.util.Properties)request.getAttribute("t")).getProperty("about.p1","Jsem Skeli – rapper, producent a nadšenec do webu. Baví mě tvořit hudbu i aplikace, které něco předají.") );
      out.write("</p>\r\n");
      out.write("  </section>\r\n");
      out.write("  <section style=\"display:grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap:16px;\">\r\n");
      out.write("    <div class=\"section\" style=\"background:rgba(255,255,255,0.55); border:1px solid var(--panel-border); border-radius:12px; padding:16px;\">\r\n");
      ...
      out.write("<p>E-mail: <a href=\"mailto:skelimc@seznam.cz\">skelimc@seznam.cz</a></p>\r\n");
      out.write("    </div>\r\n");
      out.write("  </section>\r\n");
